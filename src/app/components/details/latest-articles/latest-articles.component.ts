...
export class LatestArticlesComponent implements OnInit {
    ...
    constructor(private globalService: GlobalService, private route: ActivatedRoute, 
      private myFunctions:FunctionsService, private sharedService:SharedService, private http:HttpClient) { }
    ...
    ngOnInit() {
      ...
      this.http.get(this.globalService.globalLinks.API_URL + "Data/GetMostReadArticlesById?id=" + this.articleId + "&articleWriterId=" + this.articleWriterId).subscribe((data:any) =>{
        //console.log(data);
        this.entries = data;
